...
terminal = 'alacritty'
editor = 'nvim'
editor_launcher = terminal..' -e '..editor

emacs = "emacsclient -a 'emacs' -c"

local old_f_rel = awful.screen.focus_relative
...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "space", function() awful.spawn.with_shell("rofi -show drun -display-drun 'App Launcher' -dpi 196") end,
        {description = "Open Launcher", group = "Applications"})
...
_G['clientkeys'] = keys.clientkeys
_G['clientbuttons'] = keys.clientbuttons
